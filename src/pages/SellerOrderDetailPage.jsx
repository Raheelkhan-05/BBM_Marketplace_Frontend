    ...
    return (
        <div className="mx-auto min-h-screen max-w-3xl px-2.5 pb-10 pt-3 sm:px-4 lg:px-6">
            ...
            <Card title="Items">
                ...
                <div className="mt-3 flex items-center justify-between rounded-xl px-3 py-2" style={{ background: isSample ? "#7c3aed08" : `${C.primary}08` }}>
                    {isSample ? (
                    ...
                    <p className="flex items-center gap-0.5 text-[14px] font-extrabold tabular-nums" style={{ color: isSample ? "#7c3aed" : C.primary }}>
            ...
            <Card title="Buyer">
                ...
                <div className="mt-3 border-t pt-3" style={{ borderColor: C.hairSoft }}>
                    <p className="flex items-center gap-1.5 text-[10.5px] font-bold uppercase tracking-[0.08em]" style={{ color: C.muted }}><MapPin className="h-3 w-3" /> Ship to</p>
                    <p className="mt-1.5 text-[12px] font-medium leading-relaxed tracking-wide" style={{ color: C.ink }}>{addr.contact_name}, {addr.address_line1}{addr.address_line2 ? `, ${addr.address_line2}` : ""}, {addr.city}, {addr.state} - {addr.pincode}</p>
                </div>
                {order.buyer_notes && <p className="mt-2 text-[11.5px] font-medium italic tracking-wide" style={{ color: C.muted }}>"{order.buyer_notes}"</p>}
            </Card>
