                ...
                <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-3">
                        ...
                        <SmartLink
                            ...
                            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full p-0 text-slate-500 transition-colors hover:bg-slate-50 hover:text-slate-800"
                        >
                            <ArrowLeft
                        ...
                        >
                            ...
                            <h1
                                className="m-0 p-0 text-[18px] font-extrabold leading-none tracking-wider"
                                style={{
